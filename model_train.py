...
m, epochs, device, loss_fn, optimizer = train_setup(rexnet_model)
...
for epoch in range(epochs):
    ...
    print(f"Epoch {epoch+1} Training Loss: {tr_loss_to_track:.3f}, Accuracy: {tr_acc_to_track:.3f}, F1: {tr_f1_to_track:.3f}")
    ...
    with torch.no_grad():
        ...
        print(f"Epoch {epoch+1} Validation Loss: {val_loss_to_track:.3f}, Accuracy: {val_acc_to_track:.3f}, F1: {val_f1_to_track:.3f}")
